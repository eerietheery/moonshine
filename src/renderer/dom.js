...
export const modePlaylistsBtn = document.getElementById('mode-playlists');
export const playlistHeader = document.getElementById('playlist-header');
export const playlistUserList = document.getElementById('playlist-user');
export const playlistSmartList = document.getElementById('playlist-smart');
export const playlistActions = document.querySelector('.playlist-actions');
export const playlistUserSection = playlistUserList ? playlistUserList.closest('.sidebar-section') : null;
export const playlistSmartSection = playlistSmartList ? playlistSmartList.closest('.sidebar-section') : null;
